...
//  MovieBookingAPP
//
//  Created by Levan Gorjeladze on 14.01.23.
//
...
struct BookingView: View {
    ...
    @State var gradient = [Color("backgroundColor2").opacity(0), Color("backgroundColor2"),
        ...
        NavigationView{
            ZStack{
                ...
                VStack(spacing: 0.0){
                    ...
                    Text("Dr. Stephan Strange casts a forbidden spell that opens the doorway to multiverse, including alternative version of...")
                        .font(.subheadline)
                        .foregroundColor(.white)
                        .padding(30)
                    ...
                    NavigationLink{
                        ...
                        LargeButton()
                            .padding(20)
                            .offset(y: selectedDate && selectedHour ? 0 : 250)
                    }
                }
                .frame(maxHeight: .infinity, alignment: .top)
            }
